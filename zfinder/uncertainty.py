...
class Uncertainty(object):
    def __init__(self, x, y, ssigma):
        """ Method of calculating the uncertainty of a chi-squared plot
    ...
    def calc_uncert(self):
        ...
        params, covars = curve_fit(lambda x, a: self.quadratic(x, a, b=min_x, c=min_y), points_x, points_y)

        # Calculate the x points above lowest_y + sigma 
        neg, pos = self.solve_quadratic(min_y + self.ssigma, *params, b=min_x, c=min_y)
